<nav id="sidebar" style="background-color: #202845;">
    ...
    <div class="left-custom-menu-adp-wrap">
        <ul id="sidebar_menu" class="nav navbar-nav left-sidebar-menu-pro">
            <li class="nav-item">
                <a href="{{route('dashboard_cro')}}" role="button" aria-expanded="false"
                 class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{route('information_cro')}}" role="button" aria-expanded="false" class="nav-link">
                    <i class="fa big-icon fa-info-circle"></i> 
                    <span class="mini-dn">Information</span> 
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('dossier_cro')}}" role="button" aria-expanded="false" class="nav-link">
                    <i class="fa big-icon fa-folder"></i> <span class="mini-dn">Dossiers</span> 
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('anomalie_cro')}}" role="button" aria-expanded="false" class="nav-link">
