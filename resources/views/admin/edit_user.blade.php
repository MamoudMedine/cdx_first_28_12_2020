                                        ...
                                        <div class="col-md-4">
                                            <form action="{{route('update_user', $user->id)}}" method="POST">
                                                ...
                                                <div class="form-group text-justify">
                                                    ...
                                                    <input id="nom_utilisateur" type="text" class="form-control" name="nom_utilisateur" placeholder="Nom d'utilisateur" value="{{$user->nom_utilisateur}}">
                                                ...
                                                <div class="form-group text-justify">
                                                    ...
                                                    <select name="role" id="role" class="form-control">
                                                        <option {{$user->roles == '["ROLE_CODEX"]' ? 'selected' : ''}} value="ROLE_CODEX">Codex</option>
                                                        <option {{$user->roles == '["ROLE_COOPEC"]' ? 'selected' : ''}} value="ROLE_COOPEC">Coopec</option>
                                                        <option {{$user->roles == '["ROLE_ADMIN"]' ? 'selected' : ''}} value="ROLE_ADMIN">Admin</option>
                                                    </select>
                                                </div>
