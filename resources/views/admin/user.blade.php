                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd" style="background-color: white;">
                                    <div class="main-sparkline13-hd">
                                        <h1>Utilisateurs <a href="{{route('add_user_form')}}" class="btn btn-primary">
                                            <i class="fa fa-user-plus"></i> Ajouter</a></h1>
                                        ...
                                        data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="id">Noms utilisateurs</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($users as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('edit_user', $item->id)}}" style="border-radius: 25px;" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> Editer</a>
                                                            <a href="{{route('delete_user', $item->id)}}" style="border-radius: 25px;" class="btn btn-danger" id="delete_user">
