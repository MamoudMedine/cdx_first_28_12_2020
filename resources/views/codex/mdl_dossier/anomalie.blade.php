<div class="modal fade" id="dos_anomalie_mdl" role="dialog">
        ...
        <div class="modal-content">
            ...
            <form action="">
                <div class="modal-body" style="background-color: #bce8f1;">
                    <p>
                        <span><b>ID:</b>&nbsp;</span><span class="mdl_dos_sms_cod_dos"></span><br>
{{--                        <span><b>Non du client:</b>&nbsp;</span><span class="mdl_dos_sms_nom_clt"></span><br>--}}
{{--                        <span><b>Adresse du client:</b>&nbsp;</span><span class="mdl_dos_sms_adr_clt"></span><br>--}}
{{--                        <span><b>Telephone:</b>&nbsp;</span><span class="mdl_dos_sms_tel_clt"></span><br>--}}
{{--                        <span><b>Genre:</b>&nbsp;</span><span class="mdl_dos_sms_genre_clt"></span><br>--}}
                    </p>
                    <p>
                    ...
                    <div class="form-group">
                        <label for="dos_anomalie_commentaire">Commentaire:</label>
                        <textarea class="form-control dos_anomalie_commentaire" name="dos_anomalie_commentaire"
                                  id="dos_anomalie_commentaire"
