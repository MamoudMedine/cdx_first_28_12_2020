<div class="modal fade" id="dos_visit_mdl" role="dialog">
                ...
                <div class="modal-body" style="background-color: #bce8f1;">
                    ...
                    <p>
                        <div class="form-group">
                            ...
                            <textarea class="form-control dos_visit_commentaire" name="dos_visit_commentaire" id="dos_visit_commentaire"
                                      cols="5" rows="5">
                            </textarea>
                        </div>
                    </p>
