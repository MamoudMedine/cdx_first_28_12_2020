...
<head>
    ...
    <title>Coopec | Administration</title>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            @endif
                                            <form action="{{route('update_user_coopec', Auth::user()->id)}}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="form-group text-justify">
                                                    ...
                                                    <input id="new_password" type="password" class="form-control" name="new_password" placeholder="Nouveau mot de passe">
                                                    @error('new_password')
                                                        <span class="invalid-feedback text-theme-6" role="alert" style="color: red;">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="form-group text-justify">
                                                    <button type="submit" class="btn btn-danger">Modifer</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
