                                        ...
                                        <form action="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2" style="justify-content: left;">
                                                    <button class="btn btn-danger btn_filtre_par_type" data-url="{{route('filtre_anomalies')}}" style="float: left;">
...
@include('coopec.mdl_anomalie.anomalie')
@include('coopec.mdl_anomalie.detail')
@include('coopec.mdl_anomalie.visit')
@include('coopec.mdl_anomalie.call')
@include('coopec.mdl_anomalie.sms')
<script src="{{asset('asset/js/coopec/anomalie.js')}}"></script>
